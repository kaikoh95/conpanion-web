        ...
        <Popover modal open={showPopup} onOpenChange={setShowPopup}>
          ...
          >
            <Command className="overflow-visible">
              ...
              <CommandEmpty>
                {loading ? 'Loading...' : membersError ? 'Error loading members' : 'No members found.'}
              </CommandEmpty>
              <CommandGroup>
                {members.map((member: ProjectMember) => {
                  ...
                  return (
                    <CommandItem
                      ...
                      className="flex items-center justify-between gap-2 cursor-pointer hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                    >
